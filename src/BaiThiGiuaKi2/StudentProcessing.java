...
public class StudentProcessing{
        ...
        try {
            ...
            for (int i = 0; i < studentList.getLength(); i++) {
                ...
                executor.submit(() -> {
                    ...
                    writeStudentToXml(id, name, address, age, encodedAge, isPrime);
                });
            }
    ...
    private static void writeStudentToXml(String id, String name, String address, int age, String encodedAge, boolean isPrime) {
        try {
